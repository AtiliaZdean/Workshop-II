...
// Query for approved volunteers
$queryApprovedVolunteers = "SELECT VolunteerID, MatricNo, Name FROM volunteer WHERE Status = 'Active' AND ManagerID IS NULL AND RoleID NOT IN (5, 8)";
$stmtApproved = $conn->prepare($queryApprovedVolunteers);
    ...
    <div class="sidebar">
        ...
        <?php if (isset($_SESSION['VolunteerID'])): ?>
            <?php if (isset($_SESSION['RoleID']) && $_SESSION['RoleID'] == 8): ?>
                ...
                <a href="assignation.php" class="active">Manager Assignment</a>
