...
<html lang="en">
    <head>
        ...
        <!-- referring to css files for graphics -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
        <a class="navbar-brand" href="dashboard_final.php">FoodShare</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="dashboard_final.php" class="nav-link">Home</a></li>
                ...
                <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                    <div class="block-18 color-3 align-items-stretch">
                        <div class="text">
              	            ...
              	            <p>Even the all-powerful Pointing has no control about the blind texts.</p>
              	            <p><a href="signup.php" class="btn btn-white px-3 py-2 mt-2">Be A Volunteer</a></p>
                        </div>
                    </div>
                </div>
    		</div>
