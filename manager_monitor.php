    ...
    <div class="sidebar">
        ...
        <?php if (isset($_SESSION['VolunteerID'])): ?>
            <?php if (isset($_SESSION['RoleID']) && $_SESSION['RoleID'] == 5): ?>
                <a href="manager_monitor.php" class="active">Manager Monitor</a>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-7 text-center heading-section">
                        <h2 class="mb-4">Manager Monitor</h2>
                        <p>See details of your volunteers.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                // Adjusted query to match the requirements
                                $query = "SELECT 
