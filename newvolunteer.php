...
// Query for pending volunteer registrations
$queryPendingVolunteers = "SELECT v.VolunteerID, v.MatricNo AS 'Matric Number', v.Name AS 'Name', v.ContactNo AS 'Contact', v.YearOfStudy AS 'Year Of Study', v.JoinDate AS 'Date', r.RoleName AS 'Role', p.ProgrammeName AS 'Programme'
                                                FROM volunteer v
                                                JOIN role r ON v.RoleID = r.RoleID
                                                JOIN programme p ON v.ProgrammeID = p.ProgrammeID 
                                                WHERE v.Status = 'Pending' AND r.RoleID IN (1, 2, 4, 6, 7)";
